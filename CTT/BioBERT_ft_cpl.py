...
if args.task == 'chemprot':
    dataset_dict = dataset_dict_loader(args.input_dir,label_list_dict[args.task])
    config = transformers.BertConfig.from_pretrained(args.config_file, num_labels=len(label_list_dict[args.task]))
...
if args.task == 'i2b2':
    ...
    config = transformers.BertConfig.from_pretrained(args.config_file,num_labels=20,problem_type="multi_label_classification")
