...
model = transformers.BertForSequenceClassification.from_pretrained(args.init_checkpoint,config=config)
...
tokenizer = transformers.BertTokenizer.from_pretrained(args.vocab_path)
