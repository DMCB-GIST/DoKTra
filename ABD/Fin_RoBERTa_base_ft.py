...
config = transformers.RobertaConfig.from_pretrained(args.config_file if args.config_file is not None else "roberta-base", num_labels=3)


print("########## Initializing model ... ##########")

model = transformers.RobertaForSequenceClassification.from_pretrained(args.init_checkpoint if args.init_checkpoint is not None else "roberta-base",
                                                                      config=config)
...
tokenizer = transformers.RobertaTokenizer.from_pretrained(args.vocab_path if args.vocab_path is not None else "roberta-base")
